  ...
  const plans = [
    {
      title: 'Monthly',
      price: '$20',
      features: ['Access Premium tools', 'Track 3 goals', 'Community Support', 'Premium Reports', 'Cancel anytime'],
    },
    {
      title: 'Annually',
      price: '$240',
      features: ['Access Premium tools', 'Track 3 goals', 'Community Support', 'Premium Reports', 'Save 20% yearly'],
    },
  ];
